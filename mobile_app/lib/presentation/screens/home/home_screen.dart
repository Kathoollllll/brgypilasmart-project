          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                    'Welcome to BrgyPilaSmart! How can we assist you today?',
                    style: TextStyle(fontSize: 13, color: AppColors.textSub)),
                const SizedBox(height: 20),

                // Request Document Card
                _RequestDocumentBanner(
                    onTap: () =>
                        Navigator.pushNamed(context, AppRoutes.requestCats)),
                    ...
                    builder: (ctx, snap) {
                      ...
                      if (reqs.isEmpty) {
                        return const EmptyState(
                            ...
                            subtitle:
                                'Submit your first barangay document request.');
                      }
                      return Column(
                        children: reqs
                            .take(3)
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                        'Request your barangay documents online – fast and easy.',
                        style: TextStyle(
